...
export const experience: Experience[] = [
  {
    id: 'exp-1',
    role: 'Senior WordPress Developer (Remote)',
    company: 'GAOTek Inc. (GAO Group) — New York, USA',
    period: 'May 2025 – Present',
    description: 'Manage WordPress infrastructure across 10+ corporate domains, including GAORFID and GAOTek, ensuring consistent uptime, security, and performance.',
    technologies: ['WordPress', 'PHP', 'GA4', 'GTM', 'CDN', 'Technical SEO'],
    current: true,
    highlights: [
      'Reduced Largest Contentful Paint (LCP) by ~30% by re-architecting caching strategy, optimizing assets, and integrating CDN delivery',
      'Implemented GA4 and Google Tag Manager (GTM) tracking alongside CRM integrations to support marketing analytics and lead-generation workflows',
      'Maintain platform stability and search visibility through ongoing technical SEO improvements, security monitoring, plugin/core updates, and automated backup management',
      'Manage WordPress infrastructure across 10+ corporate domains',
    ],
  },
  {
    id: 'exp-2',
    role: 'WordPress & Shopify Developer (Freelance — Global Clients)',
    company: 'Upwork, Fiverr, Direct Contracts',
    period: 'May 2022 – Present',
    description: 'Delivered 60+ production websites across eCommerce, SaaS, and corporate sectors for international clients.',
    technologies: ['WordPress', 'Shopify', 'WooCommerce', 'Liquid', 'Performance'],
    current: false,
    highlights: [
      'Delivered 60+ production websites across eCommerce, SaaS, and corporate sectors',
      'Built custom WooCommerce functionality and Shopify Liquid sections that improved user experience and product conversion rates',
      'Achieved 90+ Google PageSpeed scores on multiple projects through advanced front-end and server-side performance optimization',
      'Integrated payment gateways, CRM systems, analytics platforms, and marketing tools',
    ],
  },
  {
    id: 'exp-3',
    role: 'WordPress Developer',
    company: 'Orbiski — Germany (Remote)',
    period: 'Jul 2021 – Apr 2022',
    description: 'Converted Figma and PSD designs into fully responsive WordPress themes using modern CSS and JavaScript practices.',
    technologies: ['WordPress', 'WooCommerce', 'CSS', 'JavaScript', 'Figma'],
    current: false,
    highlights: [
      'Converted Figma and PSD designs into fully responsive WordPress themes',
      'Customized WooCommerce product pages and checkout flows to improve on-site conversion rates',
    ],
  },
  {
    id: 'exp-4',
    role: 'WordPress Developer Intern',
    company: 'Bitbysoft — Finland (Remote)',
    period: 'Feb 2021 – Apr 2021',
    description: 'Assisted with theme customization and front-end performance optimization within Agile development workflows.',
    technologies: ['WordPress', 'Git', 'CSS', 'Agile'],
    current: false,
    highlights: [
      'Assisted with theme customization and front-end performance optimization within Agile development workflows',
      'Used Git version control to support collaborative development and deployment processes',
    ],
  },
]
